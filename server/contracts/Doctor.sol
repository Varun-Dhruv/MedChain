...
contract Doctor is User {
   ...
   event DocRegistered(uint256 _docid,uint256 _dob,string _firstName,string _lastName);

   function registerDoc(uint _dob,string memory _firstName,string memory _lastName) public {
